...
std::string dynamic_line(talk_topic topic, game* g, npc* p)
{
    ...
    case TALK_SHELTER:
        ...
        {
        case 1:
            return "Well, I guess it's just us.";
        case 2:
    ...
    case TALK_COMBAT_COMMANDS:
    {
        ...
        {
        case ENGAGE_NONE:
            status << "not engaging enemies.";
            break;
        case ENGAGE_CLOSE:
            status << "engaging nearby enemies.";
            break;
        case ENGAGE_WEAK:
            status << "engaging weak enemies.";
            break;
        case ENGAGE_HIT:
            status << "engaging enemies you attack.";
            break;
        case ENGAGE_ALL:
