...
void mattack::ratking(game *g, monster *z)
{
    ...
    case 1:
        g->add_msg("\"YOU... ARE FILTH...\"");
        break;
    case 2:
        g->add_msg("\"VERMIN... YOU ARE VERMIN...\"");
        break;
    case 3:
        g->add_msg("\"LEAVE NOW...\"");
        break;
    case 4:
        g->add_msg("\"WE... WILL FEAST... UPON YOU...\"");
        break;
    case 5:
        g->add_msg("\"FOUL INTERLOPER...\"");
        break;
    }
