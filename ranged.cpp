...
// Burst-fire weapons allow us to pick a new target after killing the first
        ...
        case AT_SHOT:
            ...
            break;
        case AT_9MM:
            casing_type = itm_9mm_casing;
            break;
        case AT_38:
            casing_type = itm_38_casing;
            break;
        case AT_40:
            casing_type = itm_40_casing;
            break;
        case AT_44:
            casing_type = itm_44_casing;
            break;
        case AT_45:
            casing_type = itm_45_casing;
            break;
        case AT_57:
            casing_type = itm_57mm_casing;
            break;
        case AT_46:
            casing_type = itm_46mm_casing;
            break;
        case AT_762:
            casing_type = itm_762_casing;
            break;
        case AT_223:
            casing_type = itm_223_casing;
            break;
        case AT_3006:
            casing_type = itm_3006_casing;
            break;
        case AT_308:
            casing_type = itm_308_casing;
            break;
        case AT_40MM:
            casing_type = itm_40mm_casing;
            break;
